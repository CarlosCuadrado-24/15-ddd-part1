...
public class CombatIntrigueCard implements IValueObject {

    private final String name;
    private final String effect;
    private final Integer stack;

    private CombatIntrigueCard(String name, String effect, Integer stack) {
        this.name = name;
        this.effect = effect;
        this.stack = stack;
    }

    public static CombatIntrigueCard of(String name, String effect, Integer stack){
        return new CombatIntrigueCard(name, effect, stack);
    }
