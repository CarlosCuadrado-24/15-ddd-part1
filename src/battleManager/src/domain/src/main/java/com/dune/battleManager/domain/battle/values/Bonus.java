...
public class Bonus implements IValueObject {

    private final String name;
    private final String effect;
    private final Integer stack;

    private Bonus(String name, String effect, Integer stack) {
        this.name = name;
        this.effect = effect;
        this.stack = stack;
    }

    public static Bonus of(String name, String effect, Integer stack){
        return new Bonus(name, effect, stack);
    }
