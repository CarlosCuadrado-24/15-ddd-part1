...
public class PlayerRequest {
    ...
    public PlayerRequest(String name, Integer victoryPoints, Boolean deployedAgent, String alliance, Integer battleStrength, ArrayList<ResourceRequest> resources, ArrayList<CombatIntrigueCardRequest> combatIntrigueCard, LeaderRequest leader, GarrisonRequest garrison) {
        this.name = name;
